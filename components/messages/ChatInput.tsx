  ...
  return (
    ...
    >
      ...
      {mediaPanelMode === "emoji" && (
        <div className="absolute bottom-[calc(100%-0.5rem)] left-2.5 z-30 flex max-w-[min(22rem,calc(100vw-1.25rem))] flex-col gap-2 lg:bottom-[calc(100%_+_1rem)] lg:left-4">
      ...
      {mediaPanelMode === "gif" && (
        <div
          className="absolute bottom-[calc(100%-0.5rem)] left-2.5 right-2.5 z-30 overflow-hidden rounded-[1.6rem] border border-white/45 bg-white/92 shadow-xl backdrop-blur-xl dark:border-white/10 dark:bg-zinc-900/92 lg:bottom-[calc(100%_+_1rem)] lg:left-4 lg:right-4"
        >
